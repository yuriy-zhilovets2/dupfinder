...
Алгоритмы проверялись на базе MySQL в 1.200.000 изображений и показали приемлемую скорость работы (15 сек для поиска на компьютере с HDD и процессором AMD Phenom(tm) 8450 X3 - 1 Ghz).
