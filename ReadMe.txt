...
нанесенными небольшими надписями, и другими правками косметического характера.  Алгоритм не стоек к обрезке картинок и позволяет найти только дубликаты, лишь слегка отличающиеся друг от друга в плане кадрирования (например, обрезанные на несколько пикселей со всех сторон).

Описание использованных алгоритмов: https://habr.com/ru/post/715714/

Алгоритмы проверялись на базе в 1.200.000 изображений и показали приемлемую скорость работы (15 сек для поиска на компьютере с HDD и процессором AMD Phenom(tm) 8450 X3 - 1 Ghz).
